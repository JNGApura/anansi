//
//  UICollectionView+UIGestureRecognizerDelegate.swift
//  RevealableCell
//
...
extension UICollectionView: UIGestureRecognizerDelegate {
    ...
    open override func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey : Any]?, context: UnsafeMutableRawPointer?) {
        if context == &AssociationKey.panGesture && keyPath == "contentOffset" {
            updateCollectionViewCellFrames()
            return
        }
    ...
    fileprivate func updateCollectionViewCellFrames() {
    ...
    @objc func handleRevealPan(_ gesture: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            UIView.animate(withDuration: 0.3, delay: 0, options: [.curveEaseOut], animations: {
                ...
                self.updateCollectionViewCellFrames()
