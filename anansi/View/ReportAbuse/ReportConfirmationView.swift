...
class ReportConfirmationView: UIViewController, UIGestureRecognizerDelegate {
    ...
    var user : User? {
        didSet {
            userProfileImage.loadImageUsingCacheWithUrlString((user?.profileImageURL)!)
        }
    }
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        UIView.animate(withDuration: 0.2, delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: 1, options: UIViewAnimationOptions.curveEaseIn, animations: {
